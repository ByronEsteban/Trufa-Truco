...
void imprimir(std::vector<std::string> &opciones, std::vector<Carta> &cartas_tiradas_jug, std::vector<Carta> &cartas_tiradas_ia, std::vector<Carta> &mano_jugador, bool turno_jug); //7 - 1.2.3 - imprimir.cpp
...
bool comparar_tanto(int tanto_jug, int tanto_ia, bool jugador_es_mano, bool quien_canta); //14 - 1.2.6.1 y 1.3.1 - envido.cpp
